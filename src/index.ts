...
interface ImageDataParams {
	...
	h?: number
	v?: number
	effect?: (r: number, g: number, b: number, a: number) => { r: number, g: number, b: number, a: number }
}
...
function imageData(ctx: CanvasRenderingContext2D, { x, y, w, h, effect }: ImageDataParams) {
	x ??= 0
	y ??= 0
	w ??= ctx.canvas.width
	h ??= ctx.canvas.height
 ...
 * Invert image color
 */
export function inverseColor(this: CanvasRenderingContext2D, { x, y, w, h }: ImageDataParams) {
	imageData(this, { x, y, w, h, effect: (r, g, b, a) => Object({ r: 255 - r, g: 255 - g, b: 255 - b, a }) })
}
/**
 * Image grayscale processing
 */
export function grayProcessing(this: CanvasRenderingContext2D, { x, y, w, h }: ImageDataParams) {
	imageData(this, {
 ...
 * Image exposure
 */
export function exposure(this: CanvasRenderingContext2D, { x, y, w, h, v }: ImageDataParams) {
	imageData(this, {
		x, y, w, h, effect: (r, g, b, a) => {
			v ??= 1
 ...
 * Image contrastRatio
 */
export function contrastRatio(this: CanvasRenderingContext2D, { x, y, w, h, v }: ImageDataParams) {
	imageData(this, {
		x, y, w, h, effect: (r, g, b, a) => {
			v ??= 1
 ...
 * Image luminance
 */
export function luminance(this: CanvasRenderingContext2D, { x, y, w, h, v }: ImageDataParams) {
	imageData(this, {
		x, y, w, h, effect: (r, g, b, a) => {
			v ??= 1
 ...
 * Image layer size
 */
export function layerSize(this: CanvasRenderingContext2D, { x, y, w, h }: ImageDataParams): IRect {
	x ??= 0
	y ??= 0
	w ??= this.canvas.width
